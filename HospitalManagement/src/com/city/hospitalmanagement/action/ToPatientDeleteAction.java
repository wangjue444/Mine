...
/**
 * Servlet implementation class ToPatientDeleteAction
 */
@WebServlet("/patient/todelete.do")
public class ToPatientDeleteAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ToPatientDeleteAction() {
        super();
