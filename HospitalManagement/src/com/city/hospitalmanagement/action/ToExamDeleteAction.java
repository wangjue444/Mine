...
/**
 * Servlet implementation class ToExamDeleteAction
 */
@WebServlet("/exam/todelete.do")
public class ToExamDeleteAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ToExamDeleteAction() {
        super();
