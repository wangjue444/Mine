...
/**
 * Servlet implementation class ExamAddAction
 */
@WebServlet("/exam/add.do")
public class ExamAddAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExamAddAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				ieb.add(patientid, time, breath, pluse, temperature, bloodpressure);
