  ...
  <div class="container">
    ...
    ================================================== -->
      ...
      <div class="span9">
        ...
        医治计划编号：<input type="text" class="input-block-level disabled"    name="planid"  value="${planid}" readonly/>
        时间：<input type="text" class="input-block-level"   name="time"  value="${time}" />
       事件：<input type="text" class="input-block-level"   name="event" value="${event}" />
       	频率:<input type="text" class="input-block-level"   name="howoften"  value="${howoften}" />
       	详细：<input type="text" class="input-block-level"   name="details"  value="${details}" />
